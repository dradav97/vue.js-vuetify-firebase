      ...
      <v-sheet height="600">
            ...
            <v-card>
                <v-container>
                   <v-form @submit.prevent="addEvent">
                       ...
                       <v-text-field type="text" label="Agregar un detalle" v-model="details">                           
                       </v-text-field>
        ...
        >
          ...
          >
            ...
            <!-- aqui ponemos el formulario de editar-->
            <v-card-text>
            ...
            <v-card-actions>
              ...
              <v-btn text v-if="currentlyEditing !== selectedEvent.id" @click.prevent="editEvent(selectedEvent.id)">
                  Editar
              </v-btn>
